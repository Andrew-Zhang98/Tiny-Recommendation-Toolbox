...
parser.add_argument('--train_dir', type=str, default="./train_log/SASRec")
...
for epoch in range(epoch_start_idx, args.num_epochs + 1):
    ...
    for step in range(num_batch):  # tqdm(range(num_batch), total=num_batch, ncols=70, leave=False, unit='b'):
        ...
        # uids, u_items, u_users, u_users_items = get_usermodel_data1(u)
        pos_logits, neg_logits = model(u, seq, pos, neg)  # seq,pos,neg: (b,50) ignore u
